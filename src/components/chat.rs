...
impl Component for Chat {
                    ...
                    MsgTypes::Users => {
                        ...
                        self.users = users_from_message
                            ...
                            .map(|u| UserProfile {
                                name: u.into(),
                                avatar: format!(
                                    "https://img.freepik.com/free-psd/3d-illustration-person-with-pink-hair_23-2149436186.jpg?t=st=1715052583~exp=1715056183~hmac=a479dde73f9475880b5178e3d8fef7335d31edc67ccc78a27e79414cbe5a91f9&w=740",
    ...
    fn view(&self, ctx: &Context<Self>) -> Html {
        ...
        html! {
            <div class="flex w-screen" style="background-color: #FFFBE7;">
                 <div class="flex-none w-56 h-screen" style="background-color: #FFFBE7;">
                ...
                <div class="grow h-screen flex flex-col" style="background-color: #ECF3F1;">
